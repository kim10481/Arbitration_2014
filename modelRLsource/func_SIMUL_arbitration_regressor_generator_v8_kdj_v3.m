function func_SIMUL_arbitration_regressor_generator_v8_kdj_v3(falg)
% clear; clc;
warning('off')
...
TYPE_REGRESSOR=[1 1, 1.5 1.5, 1.5 1.5, 1.5 1.5, 1.5, 1.5, 1.5 1.5 1.5 1.5 1.5 1.5 1.5, 3 3 3 3 1.5 3 2 3 3 3 3 1.5 1.5 1.5 1.5]; % 1: parametric modulation (0-duration), 1.5:parmetric modulation (non-zero duration), 1.7:parametric modulation (with decision onset)  2: extra continuous parametric modulation (TR-fixed) - this will be used by "dummy" regressor. 3 : IDK
...
elseif falg == 1
    param_regressor_type_cue={'SPE','RPE','MAXinvFano12','SPE_BL','uncertaintyM1','Qsarsa','Qfwd','Qarb','weigtM2'};
elseif falg == 2 %SPE_BL, vmpfc2 negative
    param_regressor_type_cue={'SPE','RPE','uncertaintyM1','SPE_BL','MAXinvFano12','Qsarsa','Qfwd','Qarb','weigtM2'};
elseif falg==3 %weightM2, vmpfc2 positive
    param_regressor_type_cue={'SPE','RPE','SPE_BL','MAXinvFano12','uncertaintyM1','Qsarsa','Qfwd','Qarb', 'weigtM2'};
elseif falg==4
    param_regressor_type_cue={'SPE','RPE','MAXinvFano12','uncertaintyM1','SPE_BL','weigtM2'};
elseif falg==5    
    param_regressor_type_cue={'SPE','RPE','MAXinvFano12','SPE_BL','weigtM2'};   
elseif falg==6 %SPE_BL, vmpfc2 negative
    param_regressor_type_cue={'SPE','RPE','uncertaintyM1','SPE_BL','weigtM2'};
elseif falg==7  
    param_regressor_type_cue={'SPE','RPE','weigtM2','SPE_BL'};
elseif falg==8
    param_regressor_type_cue={'SPE','invFanoM1','uncertaintyM1','SPE_BL','weigtM1'};
elseif falg==9
    param_regressor_type_cue={'SPE','invFanoM1','SPE_BL','weigtM1'}; 
elseif falg==10
    param_regressor_type_cue={'SPE','uncertaintyM1','SPE_BL','weigtM1'};   
elseif falg==11
    param_regressor_type_cue={'SPE','invFanoM1','uncertaintyM1','SPE_BL','weigtM1'};
elseif falg==12
    param_regressor_type_cue={'SPE','RPE','invFanoM1','uncertaintyM1','SPE_BL','weigtM1'};
elseif falg==13
    param_regressor_type_cue={'SPE','invFanoM1','uncertaintyM1','SPE_BL','weigtM1'};
elseif falg==14
    param_regressor_type_cue={'RPE','invFanoM2','weigtM2'}; 
elseif falg==15
    param_regressor_type_cue={'RPE','uncertaintyM2','weigtM2'};   
elseif falg==16
    param_regressor_type_cue={'RPE','invFanoM2','uncertaintyM2','weigtM2'};
elseif falg==17
    param_regressor_type_cue={'SPE','RPE','invFanoM2','Qsarsa','Qfwd','Qarb','weigtM2'};
elseif falg==18
    param_regressor_type_cue={'SPE','RPE','invFanoM2','weigtM2'};
elseif falg==19
    param_regressor_type_cue={'SPE','RPE','uncertaintyM2','weigtM2'};
elseif falg == 20
    param_regressor_type_cue={'SPE','RPE','MAXinvFano12','uncertaintyM1','Qsarsa','Qfwd','Qarb', 'weigtM1'};
elseif falg == 21
        param_regressor_type_cue={'SPE','uncertaintyM1','weigtM1','SPE_BL'};   
elseif falg == 22
        param_regressor_type_cue={'SPE','weigtM1','uncertaintyM1','SPE_BL'};   
elseif falg == 23
        param_regressor_type_cue={'SPE','uncertaintyM1','weigtM2','SPE_BL'};   
elseif falg == 24
        param_regressor_type_cue={'SPE','weigtM2','uncertaintyM1','SPE_BL'};   
elseif falg == 25
        param_regressor_type_cue={'SPE','RPE','uncertaintyM1','SPE_BL','MAXinvFano12','weigtM2'};
elseif falg == 26
        param_regressor_type_cue={'SPE','RPE','uncertaintyM1','SPE_BL','MAXinvFano12','weigtM1'};
elseif falg == 27
        param_regressor_type_cue={'SPE','RPE','uncertaintyM1','SPE_BL','MAXinvFano12','Qsarsa','Qfwd','Qarb'};
elseif falg == 28
        param_regressor_type_cue={'SPE','RPE','MAXinvFano12','uncertaintyM1','SPE_BL','weigtM1'};
elseif falg == 29
        param_regressor_type_cue={'SPE','RPE','MAXinvFano12','uncertaintyM1','SPE_BL','weigtM2'};
elseif falg == 30
        param_regressor_type_cue={'SPE','uncertaintyM1','SPE_BL','weigtM1'};       
elseif falg == 31
        param_regressor_type_cue={'RPE','uncertaintyM2','SPE_BL','weigtM2'};       
elseif falg == 32
        param_regressor_type_cue={'SPE','SPE_BL','weigtM1'};       
elseif falg == 33
        param_regressor_type_cue={'RPE','SPE_BL','weigtM2'};       
elseif falg == 34
        param_regressor_type_cue={'SPE','uncertaintyM1','SPE_BL'};           
elseif falg == 35
        param_regressor_type_cue={'SPE','RPE','weigtM1','uncertaintyM1','SPE_BL'};   
elseif falg == 36
        param_regressor_type_cue={'SPE','RPE','uncertaintyM1','SPE_BL','weigtM1'};       
elseif falg == 37
        param_regressor_type_cue={'SPE','RPE','MAXinvFano12','SPE_BL','weigtM1'};          
elseif falg == 38
        param_regressor_type_cue={'SPE','RPE','MAXinvFano12','weigtM1','SPE_BL'};           
elseif falg == 39
        param_regressor_type_cue={'SPE','RPE','SPE_BL','weigtM1'};           
elseif falg == 40
        param_regressor_type_cue={'SPE','RPE','uncertaintyM1','weigtM1'};     
elseif falg == 41
        param_regressor_type_cue={'SPE','RPE','uncertaintyM2','weigtM1'};     
elseif falg == 42
        param_regressor_type_cue={'SPE','RPE','invFanoM1','weigtM1'};     
elseif falg == 43
        param_regressor_type_cue={'SPE','RPE','weigtM1'};                
elseif falg == 44
        param_regressor_type_cue={'SPE','RPE','PMB'};           
elseif falg == 45
        param_regressor_type_cue={'SPE','RPE','invFanoM1','invFanoM2','MAXinvFano12','Qfwd','Qsarsa','Qarb', 'weigtM1'};           
elseif falg == 46
        param_regressor_type_cue={'SPE','RPE','uncertaintyM1','weigtM1'};   
elseif falg == 47
        param_regressor_type_cue={'SPE','RPE','uncertaintyM2','weigtM1'};    
elseif falg == 48
        param_regressor_type_cue={'SPE','RPE','MAXinvFano12','weigtM1'};  
elseif falg == 49
        param_regressor_type_cue={'SPE','RPE','invFanoM1','weigtM1'};          
elseif falg == 50
        param_regressor_type_cue={'SPE','RPE','weigtM1'};         
...
elseif falg == 53
        param_regressor_type_cue={'SPE','RPE','invFanoM1','PMB'};     
elseif falg == 54
        param_regressor_type_cue={'SPE','RPE','invFanoM1','weigtM1'};     
elseif falg == 55
        param_regressor_type_cue={'SPE','RPE','uncertaintyM1','PMB'};     
elseif falg == 56
        param_regressor_type_cue={'SPE','RPE','uncertaintyM1','weigtM1'};     
elseif falg == 57
        param_regressor_type_cue={'SPE','RPE','invFanoM2','weigtM2'};     
elseif falg == 58
        param_regressor_type_cue={'SPE','RPE','uncertaintyM1','weigtM2'};    
elseif falg == 59
        param_regressor_type_cue={'SPE','RPE','MAXinvFano12','weigtM2'};     
elseif falg == 60 
        param_regressor_type_cue={'SPE','RPE','uncertaintyM2','weigtM2'};    
elseif falg == 61
        param_regressor_type_cue={'SPE','RPE','weigtM1'};         
elseif falg == 62
        param_regressor_type_cue={'SPE','RPE','weigtM2'};         
else
%         param_regressor_type_cue={'SPE','RPE', 'weigtM1', 'weigtM2','MAXinvFano12','uncertaintyM1','SPE_BL','Qfwd','Qsarsa','Qarb'};
