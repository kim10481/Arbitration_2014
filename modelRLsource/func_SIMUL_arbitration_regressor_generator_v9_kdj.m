% clear; clc;
function func_SIMUL_arbitration_regressor_generator_v9_kdj(in)
warning('off')
% in = 16;
...
LIST_REGRESSOR={'SPE', 'RPE', 'uncertaintyM1', 'uncertaintyM2', 'meanM1', 'meanM2', 'invFanoM1', 'invFanoM2', 'weigtM1', 'weigtM2', 'Qfwd', 'Qsarsa', 'Qarb', 'dQbwdEnergy', 'dQbwdMean', 'duncertaintyM1', 'dinvFanoM1', ...
    ...
    'inter_rpebl_uncer' ,'inter_rpebl_gc', 'MAXrel', 'spe_var', 'rpe_var'};
...
TYPE_REGRESSOR=[1 1, 1.5 1.5, 1.5 1.5, 1.5 1.5, 1.5, 1.5, 1.5 1.5 1.5 1.5 1.5 1.5 1.5, 3 3 3 1.5 1.5 3 2 1.5 1.5 3 3 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5]; % 1: parametric modulation (0-duration), 1.5:parmetric modulation (non-zero duration), 1.7:parametric modulation (with decision onset)  2: extra continuous parametric modulation (TR-fixed) - this will be used by "dummy" regressor. 3 : IDK
...
row_mat=[7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 ]; % from which row in the SBJ{}.regressor matrix the signal needs to be extracted. e.g., uncertainty of 0 prediction error
...
switch in
    ...
    case 14
        ...
        param_regressor_type_cue={'SPE','RPE','uncertaintyM1','MAXrel','Qsarsa','Qfwd','Qarb','SPE_BL','RPE_BL'};    
    case 15
        TYPE_REGRESSOR(29) = 1.7;
        TYPE_REGRESSOR(38) = 1.7;
        param_regressor_type_cue={'SPE','RPE','uncertaintyM1','MAXrel','Qsarsa','Qfwd','Qarb','SPE_BL','inter_spebl_maxrel'};     
    case 16
